...
SphereSelector.prototype = {
    ...
    {
        var distance = point.distanceTo( this.sphere.position );
        if(distance <= this.sphere.geometry.radius )
        console.log("Point1:"+point.x+" "+point.y+" "+point.z+" Sphere:"+this.sphere.position.x+" "+this.sphere.position.y+" "+this.sphere.position.z);
