...
Compartment.prototype = {
    addComplex:function(id, x, y, w, h,text){
        var complex = new Complex(id, x *this.w, y*this.h, w*this.w, h*this.h,text);
    ...
    addDissociation: function(id, x, y, w, h,text){
        var dissociation = new Dissociation(id, x * this.w, y * this.h, w*this.w, h*this.h,text);
    ...
    addAssociation: function(id, x, y, w, h,text){
        var association = new Association(id, x * this.w, y * this.h, w*this.w, h*this.h,text);
    ...
    addTransition: function(id, x, y, w, h,text){
        var transition = new Transition(id, x * this.w, y * this.h, w*this.w, h*this.h,text);
