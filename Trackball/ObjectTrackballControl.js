...
TrackballControls = function (object, domElement) {
    ...
    function projectOnTrackball(pageX, pageY) // The screen coordinate(or div Container)[(0,0)on the left-top] convert to the
        //trackball coordinate [(0,0) on the center of the page(or div)]
    {
