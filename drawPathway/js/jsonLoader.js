        ...
        for (var i = 0; i < compartments.length; ++i) {
            ...
            for (var j = 0; j < complexs.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addComplex(complexs[j].id, complexs[j].x, complexs[j].y, complexs[j].w, complexs[j].h,compartments[i].id);
            ...
            for (var j = 0; j < dnas.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addDNA(dnas[j].id, dnas[j].x, dnas[j].y, dnas[j].w, dnas[j].h, dnas[j].name,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < entitys.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addPhysical_Entity(entitys[j].id, entitys[j].x, entitys[j].y, entitys[j].w, entitys[j].h, entitys[j].name,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < molecules.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addSmall_Molecule(molecules[j].id, molecules[j].x, molecules[j].y, molecules[j].w, molecules[j].h, molecules[j].name,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < proteins.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addProtein(proteins[j].id, proteins[j].x, proteins[j].y, proteins[j].w, proteins[j].h, proteins[j].name,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < associations.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addAssociation(associations[j].id, associations[j].x, associations[j].y, associations[j].w, associations[j].h,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < dissociations.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addDissociation(dissociations[j].id, dissociations[j].x, dissociations[j].y, dissociations[j].w, dissociations[j].h,compartments[i].id);
                         /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
            ...
            for (var j = 0; j < transitions.length; ++j) {
                for (var k = 0; k < mainManagement.shapes.length; k++) {
                    if (mainManagement.shapes[k].id === compartments[i].id && mainManagement.shapes[k].type === "M") {
                        this.v++;
                        mainManagement.shapes[k].addTransition(transitions[j].id, transitions[j].x, transitions[j].y, transitions[j].w, transitions[j].h,compartments[i].id);
                        /*for (var m = 0; m < mainManagement.shapes.length; ++m) {
