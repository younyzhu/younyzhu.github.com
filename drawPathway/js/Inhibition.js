 ...
 */
function Inhibition(id, beginNode, endNode) {
...
Inhibition.prototype = {
    draw: function (ctx, offsetX, offsetY) {
        ...
        if (this.beginNode.type === "B" || this.beginNode.type === "K") {           //because those two has already fixed to center
            ...
            var x1 = this.beginNode.offsetX + this.beginNode.w / 2 + this.beginNode.x;
            var y1 = this.beginNode.offsetY + this.beginNode.h / 2 + this.beginNode.y;
        }
        if (this.endNode.type === "B" || this.endNode.type === "K") {
            ...
            var x2 = this.endNode.offsetX + this.endNode.w / 2 + this.endNode.x;
            var y2 = this.endNode.offsetY + this.endNode.h / 2 + this.endNode.y;
        }
